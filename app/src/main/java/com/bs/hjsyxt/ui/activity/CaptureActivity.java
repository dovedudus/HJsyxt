...
import com.bs.hjsyxt.zxing.camera.CameraManager;
import com.bs.hjsyxt.zxing.camera.PlanarYUVLuminanceSource;
import com.bs.hjsyxt.zxing.decoding.CaptureActivityHandler;
import com.bs.hjsyxt.zxing.decoding.InactivityTimer;
import com.bs.hjsyxt.zxing.decoding.RGBLuminanceSource;
import com.bs.hjsyxt.zxing.decoding.Utils;
import com.bs.hjsyxt.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            Intent resultIntent = new Intent(CaptureActivity.this, ProductDetailActivity.class);
            Bundle bundle = new Bundle();
            //传递result参数为扫描二维码获取的信息
